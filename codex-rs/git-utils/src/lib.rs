...
pub use mutation::GitPathMutationError;
pub use mutation::MAX_GIT_MUTATION_PATH_CHARS;
pub use mutation::MAX_GIT_MUTATION_PATHS;
pub use mutation::MAX_GIT_MUTATION_TOTAL_CHARS;
pub use mutation::stage_git_paths;
pub use mutation::unstage_git_paths;
