...
pub use crate::trusted_composition::TrustedRoutingAuthority;
pub use crate::trusted_composition::TrustedRoutingSnapshot;
pub use crate::trusted_composition::TrustedSyndridCompositionDependencies;
pub use crate::trusted_composition::TrustedSyndridCompositionSource;
...
pub mod legacy_core {
    ...
    pub use codex_core::RoutingRecommendation;
    pub use codex_core::RoutingRecommendationOutcome;
    pub use codex_core::RoutingRecommendationReason;
    pub use codex_core::RoutingRecommendationSnapshot;
    pub use codex_core::RoutingRecommendationUnavailableReason;
    pub use codex_core::RoutingRole;
    pub use codex_core::RoutingStrategyCandidate;
    pub use codex_core::RoutingStrategyCandidateId;
    pub use codex_core::RoutingStrategyCandidateSnapshot;
    pub use codex_core::RoutingStrategyCandidateTarget;
    pub use codex_core::RoutingStrategyEligibility;
    pub use codex_core::RoutingStrategyEligibilityEvidence;
    pub use codex_core::RoutingStrategyEvaluationInput;
    pub use codex_core::RoutingStrategyEvidence;
    pub use codex_core::RoutingStrategyIneligibility;
    pub use codex_core::RoutingStrategyInformationalEvidence;
    ...
    pub use codex_core::derive_routing_recommendation;
    pub use codex_core::evaluate_routing_strategy_candidates;
